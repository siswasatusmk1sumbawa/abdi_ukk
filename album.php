        ...
        <div class="col-sm-3">
          ...
          <form action="album.php" method="POST">
            <div class="mb-3 mt-3">
              ...
              <input type="text" class="form-control" id="namaalbum" placeholder="nama album" name="namaalbum">
            </div>
            <div class="mb-3">
              <label for="deskripsi"></label>
              <textarea name="deskripsi" id="deskripsi" class="form-control" rows="10" placeholder="deskripsi album"></textarea>
            </div>
